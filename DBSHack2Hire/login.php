...
<div class="main" align="center">
    ...
    <form name="customerreg" class="form1" align="center" action="login.php" method="POST">
	 ...
	 <input class="mail" type="text" placeholder="Username" name="uname" autofocus required>
      ...
      <input class="submit" type="submit" value="LogIn" align="center" name="submit_btn" required>
	  
	  <a href="userregistration.php"><input type="button" id="back_btn" value="SignUp" /></a>
